...
CREATE SCHEMA IF NOT EXISTS RAW
    COMMENT = 'Raw unmodified data from CoinGecko API';
...
CREATE SCHEMA IF NOT EXISTS ANALYTICS
    COMMENT = 'Aggregated analytics-ready tables';


-- ────────────────────────────────────────────
-- SECTION 2: Virtual Warehouse (compute engine)
-- ────────────────────────────────────────────
...
-- ────────────────────────────────────────────
-- SECTION 4: Verify everything was created
-- ────────────────────────────────────────────
